...
export const TOOLS: ToolMeta[] = [
  ...
  ...t("pdf-tools", [
    ...
    ["compress-pdf", "Compress PDF", "Shrink PDF file size."],
  ...
  ...t("ai-tools", [
    ["ai-summarizer", "AI Summarizer", "Condense long text into key points."],
    ["grammar-checker", "Grammar Checker", "Catch grammar and clarity issues."],
    ["rewrite-text", "Rewrite Text", "Rephrase in a different tone."],
    ["email-writer", "Email Writer", "Draft professional emails fast."],
    ["caption-generator", "Caption Generator", "Social captions that convert."],
    ["hashtag-generator", "Hashtag Generator", "Relevant hashtag sets per topic."],
